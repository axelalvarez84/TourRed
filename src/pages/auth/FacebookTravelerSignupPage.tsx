    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="flex items-center justify-center gap-2 mb-2">
          ...
          <span className="text-sm font-medium text-gray-500">Registro con Facebook</span>
        </div>
        <h2 className="text-center text-2xl font-bold text-gray-900">Completa tu perfil de Viajero</h2>
        <p className="mt-1 text-center text-sm text-gray-500">Todos los campos son necesarios para continuar.</p>
      </div>
      ...
      <div className="mt-6 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          ...
          <div className="mb-6 flex items-start gap-2 bg-blue-50 border border-blue-200 rounded-lg px-4 py-3">
            ...
            <p className="text-xs text-blue-700">Tus datos de Facebook han sido pre-llenados. Puedes editarlos si lo deseas.</p>
          </div>
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-gray-400">Email verificado por Facebook</p>
            </div>
...
export default FacebookTravelerSignupPage;
