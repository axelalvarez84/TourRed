        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <input name="email" type="email" value={formData.email} onChange={handleInputChange} required className={`mt-1 ${inputClass} ${!email ? '' : 'bg-gray-50'}`} readOnly={!!email} />
              {email && <p className="mt-1 text-xs text-gray-400">Email verificado por X</p>}
            </div>
...
export default XTravelerSignupPage;
