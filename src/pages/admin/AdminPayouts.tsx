    ...
    const ensureAgency = (agencyId: string, agencyName: string) => {
      if (!agencyMap.has(agencyId)) {
        ...
        agencyMap.set(agencyId, {
          ...
          total_pending_platform_commission: 0,
                    ...
                    <tr key={agency.agency_id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4">
                        <div className="text-sm font-semibold text-blue-700">
                          {formatCurrency(agency.total_pending_platform_commission)}
                        </div>
            ...
            <div className="space-y-3">
              <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-green-600 mt-0.5">{paymentDetails.recordsCount} registros de tours{paymentDetails.penaltiesCount > 0 ? ` + ${paymentDetails.penaltiesCount} penalizaciones` : ''}</p>
                  </div>
              ...
              {paymentDetails.recordsCount > 0 && (
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 space-y-2">
                  <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-3">Desglose de tours</p>
                  ...
                  <div className="border-t border-gray-300 pt-2 flex items-center justify-between text-sm">
                    <span className="font-medium text-gray-700">Neto a pagar por tours</span>
