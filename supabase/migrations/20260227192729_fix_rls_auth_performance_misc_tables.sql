/*
  # Fix RLS auth() performance - misc tables

  ## Summary
  Replace auth.uid() with (select auth.uid()) for per-row evaluation optimization.

  ## Tables fixed
  - tour_optional_services (3 policies)
  - integration_configs (2 policies)
  - international_tour_inquiries (2 policies)
  - admin_permissions (2 policies)
  - referral_codes (4 policies)
  - memberships (3 policies)
  - messages (1 policy)
  - discount_codes (9 policies)
  - discount_code_usage (4 policies)
  - conversations (3 policies)
  - message_participants (3 policies)
  - cookie_consents (1 policy)
  - commission_records (1 policy)
  - agency_payouts (4 policies)
  - payout_batches (4 policies)
  - batch_payouts (2 policies)
  - booking_optional_services (5 policies)
  - departure_points (5 policies)
  - tour_departure_points (4 policies)
  - tour_categories (4 policies)
*/
