...
BEGIN
  ...
  -- Points used: convert from points to pesos: points_used / 100
  ...
  -- Award 1 point per peso (CORRECT: 1 peso = 1 punto, 100 puntos = 1 peso de canje)
  v_points_to_award := FLOOR(v_amount_eligible)::integer;
