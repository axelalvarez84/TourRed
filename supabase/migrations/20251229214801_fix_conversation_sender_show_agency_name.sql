...
-- Crear función interna que hace el trabajo real
CREATE OR REPLACE FUNCTION _get_user_conversations_internal(p_user_id uuid)
RETURNS TABLE (
...
-- Crear función pública sin parámetros (para usuarios que ven sus propias conversaciones)
