/*
  ...
  2. Security
    ...
    - Agency reviews are PUBLIC (anyone can read)
    - Traveler reviews are PRIVATE (only visible to the traveler and agencies who have bookings with them)
    - Only the reviewer can create/update their own reviews
    - Reviews can only be created for completed bookings

  3. Constraints
    - One review per booking (traveler -> agency and agency -> traveler)
