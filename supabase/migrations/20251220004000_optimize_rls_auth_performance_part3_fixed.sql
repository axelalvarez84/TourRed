/*
  # Optimize RLS policies - Part 3: Remaining tables (Fixed)

  1. Changes
    - Replace auth.uid() with (select auth.uid()) in RLS policies
    - Part 3 covers: destinations, commission_records, payment_transactions, notifications,
      email_settings, platform_settings, newsletter_subscriptions, stripe tables,
      saved_tours, frequent_companions, booking_travelers
