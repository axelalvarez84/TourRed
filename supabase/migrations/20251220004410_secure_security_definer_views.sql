/*
  # Secure SECURITY DEFINER views

  1. Changes
    - Add explicit admin role checks to admin views
    - This prevents non-admins from accessing sensitive admin data
    - user_notifications already has proper filtering, no changes needed
  
  2. Security Notes
    - SECURITY DEFINER views bypass RLS, so they need explicit access controls
    - Admin views now require the calling user to be an admin
*/
