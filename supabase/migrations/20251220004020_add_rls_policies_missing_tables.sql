/*
  ...
  1. Changes
    - Add RLS policies for password_reset_codes table
    - Enable RLS for webhook_logs table (admin only access)
  
  2. Security Notes
    - password_reset_codes: Users can only access their own reset codes
    - webhook_logs: Admin-only access for debugging and monitoring
*/
