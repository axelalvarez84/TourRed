/*
  ...
  that were flagged for re-evaluating auth functions per row.
  This improves query performance significantly at scale.

  ## Tables fixed
  - admin_broadcast_messages (3 policies)
  - cfdi_invoices (5 policies)
  - cfdi_cancellation_requests (3 policies)
  - accounting_account_mapping (4 policies)
  - accounting_sync_log (3 policies)
*/
