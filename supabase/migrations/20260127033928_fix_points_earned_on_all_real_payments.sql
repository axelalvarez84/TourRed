...
BEGIN
  ...
  -- Convert points used to pesos: 100 points = 1 peso
  v_points_value_in_pesos := (p_points_used::numeric / 100);

  -- Award points on ALL real money paid (ToursRed Cash + Stripe)
  -- This is: user_payment - points_used_in_pesos
  -- 1 peso paid = 1 point earned
  v_points_to_award := FLOOR(p_user_payment - v_points_value_in_pesos)::integer;
