/*
  # Integracion Contable de Gift Cards

  Flujos:
  1. Venta (payment_status = paid) → Debe 102 Bancos / Haber 218-12 Tarjetas de Regalo Pendientes
  2. Canje (status = redeemed)     → Debe 218-12 / Haber 218-11 ToursRed Cash Monedero
  3. Vencimiento (expires_at < hoy y no canjeada) → Debe 218-12 / Haber 4090 Ingreso por Vencimiento
*/
