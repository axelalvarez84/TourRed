/*
  # Sistema de Ejecutivos de Cuenta - Parte 2

  ## Descripción
  Crea las políticas RLS, triggers automáticos y funciones de soporte para el sistema
  de ejecutivos de cuenta.

  ## Políticas RLS

  ### account_executives
  - Admins con can_manage_executives pueden ver/editar todo
  - Ejecutivos pueden ver su propio registro

  ### agency_leads
  - Ejecutivos ven y gestionan sus propios leads
  - Admins con can_manage_executives ven todos

  ### executive_commissions
  - Ejecutivos ven sus propias comisiones, pueden subir CFDI
  - Admins pueden ver, aprobar y registrar pagos

  ## Triggers Automáticos

  ### on_agency_approved
  Cuando is_approved cambia a true en agencies y registered_by_executive=true:
  - Genera comisión de tipo 'approval' para el ejecutivo asignado
  - Registra approval_period_start

  ### on_tour_published
  Cuando un tour se hace visible/activo: actualiza first_tour_published_at en agencies

  ### on_booking_paid
  Cuando payment_status = 'paid' en bookings:
  - Actualiza first_paid_booking_at en agencies si es null
  - Si primera reserva Y primer tour YA publicado Y registered_by_executive:
    genera comisión 'first_tour_and_booking'

  ## Funciones

  ### calculate_executive_platform_commissions(period_month, period_year)
  Calcula comisiones de periodo para todos los ejecutivos activos
*/
