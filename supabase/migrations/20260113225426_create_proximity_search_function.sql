...
-- Create function to get departure location suggestions (for autocomplete)
CREATE OR REPLACE FUNCTION get_departure_location_suggestions(
  search_text text,
...
-- Create helper function to update geocoding cache usage
CREATE OR REPLACE FUNCTION increment_geocoding_cache_usage(query_text text)
RETURNS void
LANGUAGE plpgsql
SECURITY DEFINER
SET search_path = public
