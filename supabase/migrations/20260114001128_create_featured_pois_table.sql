/*
  ...
  1. New Tables
    - `featured_pois`
      ...
      - `category` (text) - Type: monument, metro_station, shopping, landmark, etc.
      ...
      - `is_active` (boolean) - Whether the POI is active
      - `created_at` (timestamptz)
      - `updated_at` (timestamptz)

  2. Security
    - Enable RLS on `featured_pois` table
    - Add policy for public read access
    - Add policy for admin write access

  3. Indexes
    - Add index for text search on name and keywords
