...
-- Función para crear conversación con participantes (sin valores por defecto problemáticos)
...
DROP VIEW IF EXISTS admin_conversations;
CREATE VIEW admin_conversations AS
SELECT 
  c.id,
  c.title,
  c.type,
