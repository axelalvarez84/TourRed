...
-- Recreate award_points_for_booking WITHOUT the UPDATE bookings statement
...
BEGIN
  ...
  -- DO NOT UPDATE bookings table here - the trigger will handle it via NEW.points_earned
