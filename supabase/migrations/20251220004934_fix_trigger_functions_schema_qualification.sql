/*
  ...
  1. Changes
    - Update create_commission_record function to properly qualify table names with schema
    - Update handle_booking_approval_notification function to properly qualify table names with schema
    - These functions have SET search_path TO '' for security, so they need fully qualified names
