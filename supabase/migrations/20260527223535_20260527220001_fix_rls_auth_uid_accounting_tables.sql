/*
  # Fix Auth RLS Initialization Plan — Tablas de Contabilidad
  ...
  ## Tablas corregidas
  1. chart_of_accounts — 3 políticas (SELECT, INSERT, UPDATE)
  2. accounting_entries — 3 políticas (SELECT, INSERT, UPDATE)
  3. accounting_entry_lines — 3 políticas (SELECT, INSERT, UPDATE)
