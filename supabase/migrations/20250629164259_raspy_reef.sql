/*
  ...
  2. Security
    ...
    - Add system policy for creating notifications

  3. Functions
    - `get_user_notifications()` - Get user's notifications with pagination
    ...
    - `create_user_notification()` - Create new notification
    - `get_unread_notifications_count()` - Get count of unread notifications

  4. Views
    - `user_notifications` - User-specific view with expiration info
