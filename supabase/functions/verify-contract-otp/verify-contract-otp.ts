...
// Las fuentes NO se cargan a nivel de módulo — eso obligaba a decodificar
// ~700KB de base64 en CADA arranque en frío de la función, incluso para
// peticiones OPTIONS o intentos de OTP que fallan antes de necesitar el
// PDF. Esto probablemente causaba el 503 intermitente en boot. Ahora se
// cargan de forma perezosa, solo la primera vez que de verdad se necesitan
// dentro de una invocación, y se cachean para el resto de esa invocación.
let _fonts: {
  Roboto: {
    normal: Buffer; bold: Buffer; italics: Buffer; bolditalics: Buffer;
  };
} | null = null;
